...
func NewErrorResponse(code int32, codeType string, details []map[string]interface{}, message string) *ErrorResponse {
	this := ErrorResponse{}
	this.Code = code
...
func (o *ErrorResponse) GetCodeType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ErrorResponse) GetCodeTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorResponse) SetCodeType(v string) {
	o.CodeType = v
}
